...
packages <- c("ggplot2", "dplyr", "tidyr", "readr", "zoo", "data.table", "sf", "terra", "tmap", "stats", "randomForest", "lubridate", "trajr", "gstat", "geosphere", "nngeo", "vegan", "hms")
...
posmo_filter_segm_siuos <- posmo_filter_segm_clean |>
  filter(segment_id == 1)


aggregate(geometry ~ segment_id, data=posmo_filter_segm_clean, sinuosity)
?aggregate()
