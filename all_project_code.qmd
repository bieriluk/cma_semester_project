...
```{r}
posmo <- read_delim("datasets/posmo_2023-01-01T00-00-00-00_2023-06-16T-23-59-59_unvalidated_def.csv", delim = ",")
...
```{r}
#posmo_filter_segm_train <- posmo_filter_segm_nobike |> 
#  mutate(
#    bike = avgspeed_ms < 6.944 & maxspeed_ms <= 11.111 & seg_dist_m < 20000
#  )
...
**Ideas for writing:**
- further improvement possible with elevation modeles for bike mode detection
