...
```{r}
#| label: figure_1
#| fig-cap: "Figure 1: Overview over the context data used for MCA (swisstopo, 2022a, 2022b; Verkehrsbetriebe Zürich VBZ, 2022)"
...
From Sadeghian et al. (2022) and validated data comparison we found that spatial MCA is accurate at identifying walking segments. Walking segments are assigned with the following criteria (Sadeghian et al., 2022):
...
3. The points must be within 10 m from a railway line, 15 m from a bus or tram line and 25 m from a main road
